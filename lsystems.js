...
function setInputsFromUrl() {
  ...
  const randomizeColorsInput = document.getElementById("randomizeColorsInput");
  const randomizeLineThicknessInput = document.getElementById(
    "randomizeLineThicknessInput"
  );
  ...
  randomizeColorsInput.value =
    params.randomizeColors || randomizeColorsInput.value;
  randomizeLineThicknessInput.value =
    params.randomizeLineThickness || randomizeLineThicknessInput.value;
...
function randomize() {
  ...
  if (randomizeLineThicknessInput.checked) {
  ...
  if (randomizeColorsInput.checked) {
...
function getUrl() {
  ...
  return `index.html?canvasWidth=${encodeURIComponent(
    canvasWidth
  )}&canvasHeight=${encodeURIComponent(
    canvasHeight
  )}&foreColor=${encodeURIComponent(foreColor)}&bgColor=${encodeURIComponent(
    bgColor
  )}&lineWidth=${encodeURIComponent(
    lineWidth
  )}&iterations=${iterations}&angle=${angle}&axiom=${encodeURIComponent(
    axiom
  )}&rule1=${encodeURIComponent(rule1)}&rule2=${encodeURIComponent(
    rule2
  )}&rule3=${encodeURIComponent(rule3)}&rule4=${encodeURIComponent(
    rule4
  )}&rule5=${encodeURIComponent(rule5)}`;
}
